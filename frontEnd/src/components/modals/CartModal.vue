      ...
      <div class="card text-center" style="
        ...
        <table class="table table-bordered" style="background-color: #e92b2bff; border-color: rebeccapurple">
          <tbody>
            ...
            <tr v-if="usersStore.user && usersStore.user?.customer.points > 10 && cartStore.cart.total_price > 5">
            ...
            <tr>
              ...
              <td class="texto">{{ parseFloat(cartStore.cart.total_price).toFixed(2) }} €</td>
              <td class="texto">Total a pagar:</td>
              <td class="texto">{{ parseFloat(cartStore.cart.total_price - cartStore.cart.total_paid_with_points).toFixed(2) }} €</td>
            </tr>
          </tbody>
        </table>
        <div class="d-grid">
          <div class="btn-group" style="margin-bottom: 0.5rem">
            ...
            <button class="btn btrn-sm btn-outline-success" type="button" @click="cartStore.paymentModal = true">
              Confirmar
            </button>
          </div>
        </div>
